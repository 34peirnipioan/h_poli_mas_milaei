...
Το έργο σχεδιάστηκε και υλοποιήθηκε με τη χρήση ανοιχτών τεχνολογιών και ελεύθερα διαθέσιμων ψηφιακών εργαλείων, ώστε να μπορεί να αναπαραχθεί από οποιοδήποτε σχολείο με ελάχιστο κόστος.

| Εργαλείο     | Χρήση στο έργο                                            |
| ------------ | --------------------------------------------------------- |
| Audacity     | Ηχογράφηση και επεξεργασία των ηχοϊστοριών                |
| GitHub       | Αποθετήριο τεκμηρίωσης και διάχυσης του έργου             |
| Google Sites | Δημιουργία ψηφιακής πλατφόρμας έργου                      |
| Google Maps  | Χαρτογράφηση των σημείων τοποθέτησης των ιστοριών         |
| QR Codes     | Σύνδεση φυσικού και ψηφιακού περιβάλλοντος                |
| Padlet       | Συλλογή ανατροφοδότησης και φωτογραφιών από την κοινότητα |

## Αναπαραγωγιμότητα

Το έργο μπορεί να υλοποιηθεί από οποιοδήποτε σχολείο ακολουθώντας τα εξής βήματα:

1. Δημιουργία πρωτότυπων ιστοριών από τους μαθητές.
2. Ηχογράφηση και επεξεργασία του υλικού.
3. Δημιουργία QR Codes.
4. Επιλογή σημείων ενδιαφέροντος στην τοπική κοινότητα.
5. Δημιουργία ψηφιακού χάρτη.
6. Διάχυση στην κοινότητα μέσω φυσικών και ψηφιακών μέσων.

Η χρήση ελεύθερα διαθέσιμων εργαλείων καθιστά το έργο οικονομικά προσιτό και εύκολα επεκτάσιμο.
